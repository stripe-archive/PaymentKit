...
#import "STCardNumberTest.h"
#import "STCardNumber.h"
#define CNUMBER(string) [STCardNumber cardNumberWithString:string]

@implementation STCardNumberTest
...
- (void)testCardType
{
    STAssertEquals([CNUMBER(@"378282246310005") cardType], STCardTypeAmex, @"Detects Amex");
    STAssertEquals([CNUMBER(@"371449635398431") cardType], STCardTypeAmex, @"Detects Amex");
    STAssertEquals([CNUMBER(@"30569309025904") cardType], STCardTypeDinersClub, @"Detects Diners Club");
    STAssertEquals([CNUMBER(@"6011111111111117") cardType], STCardTypeDiscover, @"Detects Discover");
    STAssertEquals([CNUMBER(@"6011000990139424") cardType], STCardTypeDiscover, @"Detects Discover");
    STAssertEquals([CNUMBER(@"3530111333300000") cardType], STCardTypeJCB, @"Detects JCB");
    STAssertEquals([CNUMBER(@"5555555555554444") cardType], STCardTypeMasterCard, @"Detects MasterCard");
    STAssertEquals([CNUMBER(@"4111111111111111") cardType], STCardTypeVisa, @"Detects Visa");
    STAssertEquals([CNUMBER(@"4012888888881881") cardType], STCardTypeVisa, @"Detects Visa");
}
