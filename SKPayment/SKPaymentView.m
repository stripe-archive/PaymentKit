...
- (SKCardNumber*)cardNumber
{
    return [SKCardNumber cardNumberWithString:cardNumberField.text];
}

- (SKCardExpiry*)cardExpiry
{
    return [SKCardExpiry cardExpiryWithString:cardExpiryField.text];
}

- (SKCardCVC*)cardCVC
{
    return [SKCardCVC cardCVCWithString:cardCVCField.text];
}

- (SKAddressZip*)addressZip
{
    return [SKAddressZip addressZipWithString:addressZipField.text];
}
...
- (void)setPlaceholderToCVC
{
    SKCardNumber *cardNumber = [SKCardNumber cardNumberWithString:cardNumberField.text];
    SKCardType cardType      = [cardNumber cardType];
...
- (void)setPlaceholderToCardType
{
    ...
    switch (cardType) {
        case SKCardTypeAmex:
            cardTypeName = @"amex";
            break;
        case SKCardTypeDinersClub:
            cardTypeName = @"diners";
            break;
        case SKCardTypeDiscover:
            cardTypeName = @"discover";
            break;
        case SKCardTypeJCB:
            cardTypeName = @"jcb";
            break;
        case SKCardTypeMasterCard:
...
- (BOOL)cardNumberFieldShouldChangeCharactersInRange: (NSRange)range replacementString:(NSString *)replacementString
{
    ...
    SKCardNumber *cardNumber = [SKCardNumber cardNumberWithString:resultString];
...
- (BOOL)cardCVCShouldChangeCharactersInRange: (NSRange)range replacementString:(NSString *)replacementString
{
    ...
    SKCardType cardType = [[SKCardNumber cardNumberWithString:cardNumberField.text] cardType];
...
- (BOOL)addressZipShouldChangeCharactersInRange: (NSRange)range replacementString:(NSString *)replacementString
{
    ...
    SKAddressZip *addressZip = [SKAddressZip addressZipWithString:resultString];
